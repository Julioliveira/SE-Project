  ...
  <div class="mainDiv">
     ...
     <h3>Gender: ${user.gender}</h3>
      ...
      <c:if test="${sessionScope.currentUser!= null && sessionScope.currentUser.id == user.id}">
          <a class="connectionsButton" href="/messages/${user.id}">Messages</a><br/><br/>
      </c:if>

      <c:if test="${sessionScope.currentUser!= null && sessionScope.currentUser.id != user.id}">
          <a class="connectionsButton" href="/send_message/?receiver_user_id=${user.id}">Send Message</a><br/><br/>
      </c:if>
